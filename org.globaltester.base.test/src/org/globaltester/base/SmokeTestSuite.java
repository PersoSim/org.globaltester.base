...
import org.globaltester.base.util.TLVUtilTest;
...
@RunWith(Suite.class)
@SuiteClasses({ByteUtilTest.class, StringUtilTest.class, GtResourceHelperTest.class, StringUtilTest.class, TLVUtilTest.class, XmlHelperTest.class})
